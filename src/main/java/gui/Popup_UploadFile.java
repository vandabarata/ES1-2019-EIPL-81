...
/**
* <h1>Pop up Upload File!</h1>
* This pop up allows to import a file 
* When it's clicked on the Import Button.
* It is opened the new pop up that
* it allows to choose a file and import it
* If it is a valid Excel format!
* <p>
...
public class Popup_UploadFile {
	...
	/**
	 * This method is used to set the label with information
	 *  and Import button.
	 */
	...
	/**
	 * This method is used to close the Upload File Pop up
	 * after selecting the file and the file is a valid Excel format!
	 */
	public void close() {
		frame.dispose();
	}
	...
	/**
	 * This method is used to show a warning message
	 * when the selected file isn't a valid Excel format!
	 */
