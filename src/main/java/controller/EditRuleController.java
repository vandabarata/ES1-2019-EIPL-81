...
public class EditRuleController {
	...
	/**
	 * @param rule 
	 * The Controller receives a CodeQualityRule 
	...
	/**
	 * Sets what the Edit Rule Popup delete button's action is
	 * In this case, only deletes rule if it isn't default
	 */
	...
	/**
	 * Determines what the Edit Rule Popup save button's action is
	 * Before saving, it checks for the rule's content and name
	 * It won't save a new rule without a name or set conditions
	 * It also validates the conditions' validity before saving
	 */
